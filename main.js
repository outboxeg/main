...
function renderHomePage() {
    return `
        ...
        <section class="hero-section" style="position: relative; background: linear-gradient(rgba(11, 79, 63, 0.90), rgba(19, 78, 74, 0.95)), url('./field-group.png') center/cover no-repeat; color: #ffffff; padding: 4.5rem 0 4rem; overflow: hidden; border-bottom: 1px solid var(--color-border);">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem; max-width: 900px; margin: 0 auto;">
                    ...
                    <div class="card spring-hover" style="background: var(--color-bg); padding: 1.75rem; border-radius: var(--radius-lg); border: 1px solid var(--color-border); text-align: center;">
                        <div class="partner-logo-box" style="height: 100px; background: #FFFFFF; border-radius: var(--radius-md); padding: 0.75rem 1rem; display: flex; align-items: center; justify-content: center; border: 1px solid var(--color-border); margin-bottom: 1.25rem;">
                            <img src="./logo-bara.png" alt="شعار برة الصندوق – المدرسة الخضراء الذكية" style="max-height: 80px; max-width: 100%; object-fit: contain; display: block; margin: 0 auto;">
                        </div>
                    ...
                    <div class="card spring-hover" style="background: var(--color-bg); padding: 1.75rem; border-radius: var(--radius-lg); border: 1px solid var(--color-border); text-align: center;">
                        <div class="partner-logo-box" style="height: 100px; background: #FFFFFF; border-radius: var(--radius-md); padding: 0.75rem 1rem; display: flex; align-items: center; justify-content: center; border: 1px solid var(--color-border); margin-bottom: 1.25rem;">
                            <img src="./logo-israa.jpg" alt="شعار جمعية الإسراء الخيرية لتنمية المجتمع بدمنهور" style="max-height: 80px; max-width: 100%; object-fit: contain; display: block; margin: 0 auto; border-radius: 6px;">
                        </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.75rem;">
                    ...
                    <div class="card glass-card spring-hover" style="padding: 0; overflow: hidden; border-radius: var(--radius-lg); background: #FFFFFF; border: 1px solid var(--color-border);">
                        <div style="height: 200px; width: 100%; overflow: hidden; background: var(--color-muted);">
                            <img src="./field-women.png" alt="ورشة عمل تمكين المرأة والتوعية المجتمعية" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                        </div>
                    ...
                    <div class="card glass-card spring-hover" style="padding: 0; overflow: hidden; border-radius: var(--radius-lg); background: #FFFFFF; border: 1px solid var(--color-border);">
                        <div style="height: 200px; width: 100%; overflow: hidden; background: var(--color-muted);">
                            <img src="./field-group.png" alt="صورة جماعية لقيادات مشروع برة الصندوق والأسر" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                        </div>
                        <div style="padding: 1.25rem;">
                    ...
                    <div class="card glass-card spring-hover" style="padding: 0; overflow: hidden; border-radius: var(--radius-lg); background: #FFFFFF; border: 1px solid var(--color-border);">
                        <div style="height: 200px; width: 100%; overflow: hidden; background: var(--color-muted);">
                            <img src="./field-art.png" alt="نشاط الفنون والرسومات بالورق المعاد استخدامه" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                        </div>
                        <div style="padding: 1.25rem;">
                    ...
                    <div class="card glass-card spring-hover" style="padding: 0; overflow: hidden; border-radius: var(--radius-lg); background: #FFFFFF; border: 1px solid var(--color-border);">
                        <div style="height: 200px; width: 100%; overflow: hidden; background: var(--color-muted);">
                            <img src="./banner.jpeg" alt="البانر الميداني الحكومي المعتمد للمشروع" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                        </div>
                        <div style="padding: 1.25rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 2.5rem; align-items: center; text-align: center;" class="about-hero-grid">
                    <div style="max-width: 800px; margin: 0 auto;">
                        <div style="margin-bottom: 1.5rem; display: flex; justify-content: center;">
                            <img src="./logo-bara-full.png" alt="الشعار الرسمي الكامل لمشروع برة الصندوق" style="max-width: 260px; width: 100%; height: auto; border-radius: var(--radius-lg); filter: drop-shadow(0 12px 24px rgba(15, 80, 60, 0.15)); background: #ffffff; padding: 0.75rem; border: 1px solid var(--color-border);">
                        </div>
                ...
                <div class="card glass-card" style="background: var(--color-bg); padding: 2.5rem; border-radius: var(--radius-lg); border: 1px solid var(--color-border); text-align: center; max-width: 860px; margin: 0 auto; box-shadow: var(--shadow-default);">
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 3rem; flex-wrap: wrap; margin-bottom: 1.5rem;" class="dual-logos-container">
                        <div style="text-align: center;">
                            <img src="./logo-bara-full.png" alt="شعار مشروع برة الصندوق" style="max-height: 110px; width: auto; object-fit: contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.1));">
                        ...
                        <div style="text-align: center;">
                            <img src="./logo-israa.jpg" alt="شعار جمعية الإسراء الخيرية بدمنهور" style="max-height: 110px; width: auto; object-fit: contain; border-radius: 12px; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.1));">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem;">
                    ...
                    <div class="card glass-card spring-hover" style="background: var(--color-surface); border-radius: var(--radius-lg); border: 1px solid var(--color-border); overflow: hidden; box-shadow: var(--shadow-default);">
                        <div style="position: relative; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="./field-women.png" alt="دورة تدريب وتمكين المرأة" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                    ...
                    <div class="card glass-card spring-hover" style="background: var(--color-surface); border-radius: var(--radius-lg); border: 1px solid var(--color-border); overflow: hidden; box-shadow: var(--shadow-default);">
                        <div style="position: relative; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="./field-art.png" alt="ورشة الرسم والابتكار للأطفال" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                    ...
                    <div class="card glass-card spring-hover" style="background: var(--color-surface); border-radius: var(--radius-lg); border: 1px solid var(--color-border); overflow: hidden; box-shadow: var(--shadow-default);">
                        <div style="position: relative; overflow: hidden; aspect-ratio: 4/3;">
                            <img src="./field-flag.png" alt="النشيد الوطني والأنشطة المدرسية" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 1rem; right: 1rem; background: rgba(31, 122, 90, 0.9); color: #ffffff; backdrop-filter: blur(8px);">
                                التواجد بـ 26 مدرسة
                            </span>
                        </div>
                ...
                <div class="card glass-card spring-hover" style="background: var(--color-surface); border-radius: var(--radius-lg); border: 1px solid var(--color-border); overflow: hidden; margin-top: 2.5rem; box-shadow: var(--shadow-default);">
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); align-items: center;">
                        <div style="aspect-ratio: 16/10; overflow: hidden;">
                            <img src="./field-group.png" alt="قيادات المشروع والمجموعة المجتمعية" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
            ...
            <div class="container">
                ...
                <div class="form-card glass-card form-pane" id="womenFormPane" style="display: none; border-radius: var(--radius-lg); padding: 2.25rem; border: 1px solid var(--color-border); box-shadow: var(--shadow-default); background: var(--color-surface);">
                    <div style="display: flex; gap: 1.5rem; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap;">
                        <img src="./field-women.png" alt="ورشة تمكين المرأة والفتيات" style="width: 120px; height: 90px; object-fit: cover; border-radius: var(--radius-md); border: 2px solid var(--color-border);">
                        <div>
...
function initFormsLogic() {
    ...
    const setupFormHandler = (formId, formType, label) => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            // Toast Alert Confirmation displaying generated reference ID
            const confirmMessage = `تم تسجيل ${label} بنجاح! رقم المرجعية: ${refId}`;
            if (typeof window.showToast === 'function') {
                ...
                <div class="knowledge-grid" id="knowledgeGrid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="math" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-1.png" alt="وسيلة العب وتعلم الحساب بالأصابع" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="science" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-2.png" alt="لوحة تصنيف الأشكال والألوان" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="arabic" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-3.png" alt="بازل الحروف والكلمات باللغة العربية" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="math" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-4.png" alt="ساعة الوقت التعليمية من الكرتون" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="science" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-5.png" alt="لوحة دورة حياة النبات والزراعة" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="science" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-6.png" alt="لوحة الطقس والفصول وتغير المناخ" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="eco-skills" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-7.png" alt="سلة الفرز التعليمية الأربعة" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="eco-skills" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-8.png" alt="مسرح العرائس الورقي التوعوي" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
                    ...
                    <div class="card spring-hover knowledge-card" data-subject="eco-skills" style="display: flex; flex-direction: column; height: 100%; border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-default);">
                        <div style="position: relative; width: 100%; aspect-ratio: 4/3; overflow: hidden; background: var(--color-muted);">
                            <img src="./activity-9.png" alt="جدول السلوك البيئي اليومي" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease;">
                            <span class="badge badge-certified" style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(8px); font-weight: 700; color: var(--color-primary-dark);">
...
/* ==========================================================================
   ...
   Bara El-Sandouq – Smart Green School Project
   Static Website CMS Dashboard with Base64 FileReader Image Engine & Inbox
   ========================================================================== */
            ...
            <section class="section" style="padding-top: 5rem; padding-bottom: 6rem;">
                <div class="container" style="max-width: 480px;">
                    <div class="card glass-card spring-hover" style="padding: 2.5rem; border-radius: var(--radius-lg); background: var(--color-surface); border: 1px solid var(--color-border); box-shadow: var(--shadow-hover); text-align: center;">
                        ...
                        <p style="color: var(--color-text-secondary); font-size: 0.92rem; margin-bottom: 2rem;">لوحة إدارة محتوى موقع "برة الصندوق – المدرسة الخضراء الذكية"</p>
                        ...
                        <form id="adminLoginForm">
                            <div class="form-group" style="text-align: right; margin-bottom: 1.25rem;">
                                ...
                                <input type="text" class="form-input" id="adminUsername" value="admin" required style="width: 100%; padding: 0.75rem 1rem; border-radius: var(--radius-md); border: 1px solid var(--color-border); font-family: inherit;">
                            </div>
                            <div class="form-group" style="text-align: right; margin-bottom: 2rem;">
                                ...
                                <input type="password" class="form-input" id="adminPassword" placeholder="أدخل كلمة المرور (الافتراضي: admin123)" required style="width: 100%; padding: 0.75rem 1rem; border-radius: var(--radius-md); border: 1px solid var(--color-border); font-family: inherit;">
                            </div>
            ...
            <div class="container">
                ...
                <div style="background: linear-gradient(135deg, var(--color-primary-dark), #134E4A); padding: 1.75rem 2rem; border-radius: var(--radius-lg); color: #FFFFFF; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; margin-bottom: 2.5rem; box-shadow: var(--shadow-default);">
                    <div>
                        ...
                        <p style="color: #D1E8E2; font-size: 0.92rem; margin: 0;">إدارة المحتوى، الصور، المكتبة، واستقبال الرسائل والنماذج الميدانية بحفظ تلقائي في المتصفح (LocalStorage).</p>
                    </div>
                ...
                <div style="display: flex; gap: 0.5rem; border-bottom: 2px solid var(--color-border); margin-bottom: 2rem; flex-wrap: wrap;" id="adminTabsNav">
                    ...
                    <button class="admin-tab-btn" data-tab="systemTab" style="padding: 0.85rem 1.5rem; border: none; background: none; font-weight: 700; font-size: 1rem; color: var(--color-text-secondary); cursor: pointer; display: flex; align-items: center; gap: 0.5rem;">
                        <i data-lucide="settings"></i> النسخ الاحتياطي والإعدادات
                    </button>
                </div>
                ...
                <div class="admin-pane" id="inboxTabPane">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
                        ...
                        <div style="display: flex; gap: 0.5rem; align-items: center;">
                            <button class="btn btn-outline btn-sm" id="clearInboxBtn" style="border-color: #EF4444; color: #EF4444;">
                ...
                <!-- Tab 3: Base64 FileReader Image Manager -->
                            ...
                            <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="imgTargetSelect">
                                        ...
                                        <option value="heroBg">الصورة الجماعية للهيرو (برة 13.png)</option>
                                        <option value="womenPhoto">صورة ورشة تمكين السيدات (برة 12.png)</option>
                                        <option value="artPhoto">صورة رسوم وأنشطة الطلاب (برة 10.png)</option>
                                        <option value="flagPhoto">صورة فعالية رفع العلم بالجمعية (برة 11.png)</option>
                                        <option value="bannerPhoto">البانر الميداني الحكومي الرسمي (بانر برة الصندوق.jpeg)</option>
                                    </select>
                                </div>
                ...
                <div class="admin-pane" id="systemTabPane" style="display: none;">
                    <div class="card glass-card" style="padding: 2rem; border-radius: var(--radius-lg); background: var(--color-surface); border: 1px solid var(--color-border);">
                        <h2 style="font-size: 1.4rem; color: var(--color-primary-dark); margin-bottom: 1.5rem;">إعدادات النظام وتصدير النسخ الاحتياطية (JSON)</h2>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem;">
                            ...
                            <div style="background: var(--color-bg); padding: 1.5rem; border-radius: var(--radius-md); border: 1px solid var(--color-border);">
                                <h3 style="font-size: 1.15rem; color: var(--color-primary-dark); margin-bottom: 0.75rem;">تصدير واستعادة النسخة الاحتياطية</h3>
                                <p style="font-size: 0.9rem; color: var(--color-text-secondary); line-height: 1.6; margin-bottom: 1.25rem;">
                                    تنزيل ملف .json يحتوي على جميع بيانات الموقع، الرسائل الواردة، والصور المرفوعة لاستعادتها في أي وقت.
                                </p>
                            ...
                            <div style="background: #FEF2F2; padding: 1.5rem; border-radius: var(--radius-md); border: 1px solid #FCA5A5;">
                                <h3 style="font-size: 1.15rem; color: #991B1B; margin-bottom: 0.75rem;">إعادة الضبط للوضع الافتراضي الرسمى</h3>
                                <p style="font-size: 0.9rem; color: #7F1D1D; line-height: 1.6; margin-bottom: 1.25rem;">
...
function initAdminLogic() {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            if (pass === 'admin123' || pass === 'admin' || pass === '123456') {
                ...
                if (typeof window.showToast === 'function') window.showToast('❌ كلمة المرور غير صحيحة! جرب admin123');
        ...
        if (!submissions.length) {
            inboxContainer.innerHTML = `
                <div class="card" style="text-align: center; padding: 3rem; color: var(--color-text-secondary);">
                    ...
                    <p style="font-size: 0.9rem;">عندما يقوم أي زائر بتعبئة أي من نماذج التسجيل، ستظهر جميع بياناته هنا فوراً.</p>
                </div>
            `;
            ...
            html += `
                <div class="card glass-card" style="padding: 1.25rem 1.5rem; border-radius: var(--radius-md); border-right: 4px solid var(--color-primary); background: var(--color-surface);">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.5rem; margin-bottom: 0.75rem;">
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <span class="badge badge-certified">${sub.formType || 'طلب'}</span>
    ...
    if (clearInboxBtn) {
        clearInboxBtn.addEventListener('click', () => {
            if (confirm('هل أنت تأكد من رغبتك في مسح جميع الرسائل والطلبات الواردة؟')) {
                localStorage.removeItem('bara_forms_submissions');
                renderInbox();
                if (typeof window.showToast === 'function') window.showToast('تم مسح جميع الرسائل');
            }
        });
    }

    // 2. Base64 FileReader Engine Handler
    ...
    if (resetBtn) {
        resetBtn.addEventListener('click', () => {
            if (confirm('هل أنت متاكد من إعادة ضبط كافة الصور والنصوص والبيانات إلى الوضع الافتراضي الرسمي؟')) {
