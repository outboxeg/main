/* ==========================================================================
   Bara El-Sandouq – Smart Green School Platform (main.js)
   Unified Master Page Components Bundle (Apple-Grade WCAG AAA)
        ...
        <section class="section" style="background: var(--color-bg); padding: 3.5rem 0;">
            <div class="container">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1.5rem; max-width: 950px; margin: 0 auto 2rem;">
                    ...
                    <div class="card spring-hover" style="background: var(--color-surface); padding: 1.5rem; border-radius: var(--radius-lg); border: 1px solid var(--color-border); text-align: center;">
                        <div style="height: 70px; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
                            <div style="width: 56px; height: 56px; background: rgba(28, 154, 139, 0.12); color: var(--color-secondary); border-radius: 16px; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="card spring-hover" style="background: var(--color-surface); padding: 1.5rem; border-radius: var(--radius-lg); border: 1px solid var(--color-border); text-align: center;">
                        <div style="height: 70px; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
                            <div style="width: 56px; height: 56px; background: rgba(31, 122, 90, 0.12); color: var(--color-primary); border-radius: 16px; display: flex; align-items: center; justify-content: center;">
